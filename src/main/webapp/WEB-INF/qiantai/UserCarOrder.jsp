        ...
        <div class="per-cont-right">
            <div class="yhzx-jmjdcx">
                <div class="jmjdcx-top">
                    <span><a href="showAllCarorderByUserid">所有订单</a></span> |<span> <a href="findCarorderState0">未完成</a></span> |<span><a href="findCarorderState1">已完成</a></span>
                    <table border="1">
                        ...
                        <c:forEach items="${list}" var="s" varStatus="n">
                            ...
                            <tr>
                                ...
                                <td align="center">${s.startplace}--${s.endplace}</td>
                                <td align="center">
                                    <c:if test="${s.state==0}">
                                        交易进行中
                                    </c:if>
                                ...
                                <td align="center">
                                    <c:if test="${s.state==0}">
                                        <a href="editCarorderState?oid=${s.oid}">取消预订</a>
                                    </c:if>
                                    <c:if test="${s.state==1}">
                                        <a href="editCarorderState?oid=${s.oid}">再次预订</a>
                                    </c:if>
                                    <c:if test="${s.state==2}">
                                        感谢预订
                                    </c:if>
