...
<c:if test="${regUser==null}">
    <script type="text/javascript">
        window.location.href = "/login?returnurl=showAllHelpinfo";
    </script>
    <%--<script type="text/javascript">--%>
...
<div>
    ...
    <script type="text/javascript">
        function loginOut() {
            window.location.href = "<%=path%>/logout?returnurl=showAllHelpinfo";
        }
    </script>
    <!--首页轮播图-->
    <!--用车-填写订单-->
                ...
                <li class="top-one">
                    <ul class="lf one-i">
                        <li><c:if test="${regUser.sex ==true}"><img src="<%=path %>/static/images/touxiagn.png"/></c:if>
                            <c:if test="${regUser.sex ==false}"><img
                                    src="<%=path %>/static/images/touxiagnv.jpg"/></c:if>
                        </li>
                    </ul>
                    <ul class="lf one-ii">
                        <li></li>
        ...
        <div class="per-cont-right">
            <div class="yhzx-jmjdcx">
                <div class="jmjdcx-top">
                    <span><a href="showAllHelpinfo">所有求助</a></span>|<span><a
                        href="findHelpinfoStatus0">未通过</a></span>|<span><a
                        href="findHelpinfoStatus1">初审通过</a></span>|<span><a href="findHelpinfoStatus2">终审通过</a></span>
                    <table border="1">
